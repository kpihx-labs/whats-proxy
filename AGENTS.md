...
Non-MCP CLI proxy for WhatsApp. Full `whats-mcp` catalog (68 actions) as flat JSON-RPC actions
...
62/65 `whats-mcp` tools ported (3 dead labels removed) + 1 `send-batch` + 6 story actions = **68 actions** total.
